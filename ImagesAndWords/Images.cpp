...
int main()
{
	Image *im = ReadImage("img2.magi");   // the width in img2 is too large for the function to operate, so I changed the image size to be able to hold a larger range of values - int instead of uint16_t
	FreeImage(im);
